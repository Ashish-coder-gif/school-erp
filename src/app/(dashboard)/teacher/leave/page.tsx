...
export default function TeacherLeave() {
    ...
    const [leaves, setLeaves] = useState([
        ...
        },
        {
            ...
            leaveType: "Personal",
            coveringTeacher: "Ms. Priya Sharma",
            status: "Approved",
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (!formData.fromDate || !formData.toDate || !formData.reason || !formData.coveringTeacher) {
            alert("Please fill all fields");
            return;
        }

        const newLeave = {
            id: `TL${leaves.length + 4}`,
            ...
            coveringTeacher: formData.coveringTeacher,
            status: "Pending",
            appliedDate: new Date().toISOString().split('T')[0]
        };

        setLeaves([newLeave, ...leaves]);
        setFormData({ fromDate: "", toDate: "", reason: "", leaveType: "medical", coveringTeacher: "" });
        setSubmitted(true);
    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 mt-2">Apply for leave and manage your applications</p>
            </div>
                ...
                <TabsContent value="apply" className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Submit a leave request and assign a covering teacher</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="coveringTeacher">Covering Teacher</Label>
                                        <select
                                            id="coveringTeacher"
                                            name="coveringTeacher"
                                            value={formData.coveringTeacher}
                                            onChange={handleInputChange}
                                            className="w-full px-3 py-2 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-white"
                                            required
                                        >
                                            ...
                                            <option value="Mrs. Anjali Patel">Mrs. Anjali Patel</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Card>
                            <CardContent className="pt-6">
                                ...
                                <p className="text-3xl font-bold text-emerald-600">{totalDaysUsed}</p>
                                            ...
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-sm text-emerald-600 dark:text-emerald-400 mt-2">
                                                        <span className="font-medium">Covering Teacher:</span> {leave.coveringTeacher}
                                                    </p>
                                                </div>
