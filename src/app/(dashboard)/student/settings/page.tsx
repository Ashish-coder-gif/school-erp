    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 mt-2">Manage your account and academic preferences</p>
            </div>
                ...
                <TabsContent value="academic" className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Set your learning goals and preferences</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="subjects"
                                        name="subjects"
                                        value={academic.preferredSubjects}
                                        onChange={(e) => setAcademic({ ...academic, preferredSubjects: e.target.value })}
                                        className="bg-white dark:bg-slate-900"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="tutoringSlots">Weekly Tutoring Sessions</Label>
                                    <Input
                                        id="tutoringSlots"
                                        name="tutoringSlots"
                                        type="number"
                                        value={academic.tutoringSessions}
                                        onChange={(e) => setAcademic({ ...academic, tutoringSessions: e.target.value })}
                                        className="bg-white dark:bg-slate-900"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="librarySessions">Weekly Library Study Sessions</Label>
                                    <Input
                                        id="librarySessions"
                                        name="librarySessions"
                                        type="number"
                                        value={academic.librarySessions}
                                        onChange={(e) => setAcademic({ ...academic, librarySessions: e.target.value })}
                                        className="bg-white dark:bg-slate-900"
                                    />
                                </div>
                            </div>
